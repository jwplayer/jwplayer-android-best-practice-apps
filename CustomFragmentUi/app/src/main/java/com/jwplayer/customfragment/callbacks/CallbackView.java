 ...
 */
public class CallbackView extends LinearLayout implements
	...
	public CallbackView(Context context, AttributeSet attrs) {
		this(context, attrs,0);
	}

	public CallbackView(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	private void initView(){
		...
		inflate(getContext(), R.layout.view_callbacks, this);
	}
